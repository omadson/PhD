...
function dashboard(id, fData){
    ...
    function pieChart(pD){
        ...
        function mouseover(d){
            ...
            hG.update(fData.map(function(v){ 
                return [v.ano_cadastro,v.sex[d.data.type]];}),segColor(d.data.type));
        }
        //Utility function to be called on mouseout a pie slice.
        function mouseout(d){
            // call the update function of histogram with all data.
            hG.update(fData.map(function(v){
                return [v.ano_cadastro,v.total];}), barColor);
        }
    ...
    var sF = fData.map(function(d){return [d.ano_cadastro,d.total];});
    ...
    d3.csv("data/signup_per_year.csv", function(data) {        
